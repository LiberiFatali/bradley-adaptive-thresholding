"""
Original in Python 3: https://stackoverflow.com/questions/33091755/bradley-roth-adaptive-thresholding-algorithm-how-do-i-get-better-performance
...
if __name__ == '__main__':
    ...
    print('original approach:', round(time.time()-t0, 3), 's')
    threshed0.show()
    
    t0 = time.time()
    threshed1 = faster_bradley_threshold(img)
    print('w/ numpy & scipy :', round(time.time()-t0, 3), 's')
